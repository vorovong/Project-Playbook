    ...
    children: [
      ...
      new Table({
        ...
        rows: [
          ...
          new TableRow({ children: [
            cellBold("락성연 2회 + 모두의창업", 30),
            cell("수원화성문화제 기간 내 '락성연' 2회 개최 및 모두의창업 파이널오디션을 결합한 테크+로컬 융합 축제 제안", 50),
            cell("현장 제안", 20),
          ]}),
        ]
      }),
      ...
      h2("바. 모두의창업 파이널오디션 — 공존공간 제안"),
      p("공존공간에서 수원화성문화제 기간에 '모두의창업' 파이널오디션을 결합하는 방안을 제안함. 락성연 2회차에 창업 오디션 무대를 배치하여, 축제 유동 인구 속에서 로컬 창업자가 실전 검증(매출·고객 반응)을 받고, 우수 팀은 중기부 후속 지원으로 연결하는 구조임."),
      empty(),
