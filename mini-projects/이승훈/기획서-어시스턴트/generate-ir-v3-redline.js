...
const doc = new Document({
  sections: [{
    ...
    children: [
      ...
      p("790만 사업체, 1,090만 명이 일하는 시장. 규모는 크지만 경영 환경은 낙후되어 있음."),
      empty(),
      h2("The 95% Majority"),
      makeTable(["지표", "수치"], [
      ...
      p("핵심 솔루션 '슈파'로 소상공인의 경영·구매·물류를 하나로 묶음."),
      empty(),
      h2("왜 지금 가능한가"),
      ...
      empty(),
      pBold("투자자 관점: 공존 기금에 참여한 사장님은 이탈하지 않음. 내 돈이 우리 동네에 쓰이니까. 이게 경쟁사가 못 따라오는 구조임."),
      ...
      rP("같은 시장에서 이미 매출을 내고 있는 기업들의 실적임."),
      empty(),
      ...
      rP("캐시노트는 \"무료 앱으로 사업장을 모으고 → 데이터를 쌓고 → 금융사에 판다\"는 구조를 처음 만든 곳임."),
      empty(),
      ...
      p("슈파는 여기에 AI 경영 자동화와 전 업종 확장을 더함."),
      empty(),
      ...
      empty(),
      rP("CSP는 슈파의 전략적 동반자이자 투자자임. 양사 모두 수원을 거점으로 운영 중."),
      empty(),
      ...
      rP("CSP와의 JV는 외주가 아닌 공동 창업 구조. 리스크와 성과를 함께 나눔."),
      rP("CSP는 슈파의 소상공인 채널과 운영 데이터를, 슈파는 CSP의 개발 역량과 투자 네트워크를 활용함."),
      empty(),
      ...
      rP("15년간 소상공인 현장에서 쌓은 지식은 개발팀을 고용한다고 생기는 게 아님."),
