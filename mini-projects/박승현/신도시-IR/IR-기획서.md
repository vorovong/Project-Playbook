...
> | 행궁동 식음 업종 비율 (장안동·신풍동 기준) | 54% (449개 중 244개) | 수원시 상권컨설팅 2023 |
...
> | 행궁동 사업체 수 (조사 구역: 장안동·신풍동) | 449개 (식음 54%) | 수원시 상권컨설팅 2023 |
> | 행궁동 상권 전체 (구천동·남문 일대 포함) | 약 2,400개 사업자 | 현장 파악 |
>
...
| **제품 개발 인프라** | 0.35억원 | 14% | AI API, 클라우드 서버, 개발 도구. 개발 인력은 전략적 파트너와 공동 개발 (상호 이익 구조) |
| **초기 유저 확보** | 0.25억원 | 10% | 행궁동 100개소 온보딩, 마케팅 |
| **예비비** | 0.15억원 | 6% | 비상 대응 |

> **제품 개발비가 14%로 낮은 이유**: 전략적 파트너와 공동 개발 구조다.
...
## 내부 메모 — 최종본 전환 시 이 섹션 삭제

- **[미결정 #5] 유통 파트너 후보** → §4 Product. 승현님 추가 조사 후 확정 (보류 중)
- 나머지 #1~#4, #6, #7 전부 ✅ 완료
